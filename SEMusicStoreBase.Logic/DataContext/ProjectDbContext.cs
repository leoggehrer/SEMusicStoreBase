//@CodeCopy
using SEMusicStoreBase.Common.Modules.Exceptions;
using SEMusicStoreBase.Logic.Contracts;
using System.Reflection;

namespace SEMusicStoreBase.Logic.DataContext
{
    /// <summary>
    /// Represents the database context for the SEMusicStoreBase application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=SEMusicStoreBase.db";
        #endregion fields
