...
namespace SEMusicStoreBase.WebApi.Controllers
{
    ...
    partial class ContextAccessor
    {
        ...
        {
            if (typeof(TEntity) == typeof(SEMusicStoreBase.Logic.Entities.Album))
            {
                entitySet = GetContext().AlbumSet as Logic.Contracts.IEntitySet<TEntity>;
                handled = entitySet != default;
            }
            if (typeof(TEntity) == typeof(SEMusicStoreBase.Logic.Entities.Artist))
            {
                entitySet = GetContext().ArtistSet as Logic.Contracts.IEntitySet<TEntity>;
                handled = entitySet != default;
            }
            if (typeof(TEntity) == typeof(SEMusicStoreBase.Logic.Entities.Genre))
            {
                entitySet = GetContext().GenreSet as Logic.Contracts.IEntitySet<TEntity>;
                handled = entitySet != default;
            }
            if (typeof(TEntity) == typeof(SEMusicStoreBase.Logic.Entities.Track))
            {
                entitySet = GetContext().TrackSet as Logic.Contracts.IEntitySet<TEntity>;
                handled = entitySet != default;
            }
        }
        /// <summary>
