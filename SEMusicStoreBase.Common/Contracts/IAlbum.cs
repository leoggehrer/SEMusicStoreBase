...
namespace SEMusicStoreBase.Common.Contracts
{
    ...
    /// </summary>
    public partial interface IAlbum : CommonContracts.IVersionable
    {
        IdType ArtistId { get; set; }
        ...
        void CopyProperties(IAlbum other)
        {
            bool handled = false;
        ...
        partial void BeforeCopyProperties(IAlbum other, ref bool handled);
        /// <summary>
        ...
        partial void AfterCopyProperties(IAlbum other);
    }
}
