...
namespace SEMusicStoreBase.MVVMApp.ViewModels
{
    ...
    /// </summary>
    public partial class AlbumsViewModel : GenericItemsViewModel<Models.Album>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static AlbumsViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlbumsViewModel"/> class (created by the generator.)
        /// </summary>
