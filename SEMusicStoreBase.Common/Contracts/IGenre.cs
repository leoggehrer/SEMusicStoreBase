...
namespace SEMusicStoreBase.Common.Contracts
{
    ...
    /// </summary>
    public partial interface IGenre : CommonContracts.IVersionable
    {
        ...
        partial void BeforeCopyProperties(IGenre other, ref bool handled);
        /// <summary>
        ...
        partial void AfterCopyProperties(IGenre other);
    }
}
