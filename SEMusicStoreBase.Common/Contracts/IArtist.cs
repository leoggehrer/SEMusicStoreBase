...
namespace SEMusicStoreBase.Common.Contracts
{
    ...
    /// </summary>
    public partial interface IArtist : CommonContracts.IVersionable
    {
        ...
        partial void BeforeCopyProperties(IArtist other, ref bool handled);
        /// <summary>
        ...
        partial void AfterCopyProperties(IArtist other);
    }
}
