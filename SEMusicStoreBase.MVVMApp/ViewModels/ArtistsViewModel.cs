...
namespace SEMusicStoreBase.MVVMApp.ViewModels
{
    ...
    /// </summary>
    public partial class ArtistsViewModel : GenericItemsViewModel<Models.Artist>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static ArtistsViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArtistsViewModel"/> class (created by the generator.)
        /// </summary>
