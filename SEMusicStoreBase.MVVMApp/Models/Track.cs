...
namespace SEMusicStoreBase.MVVMApp.Models
{
    using System;
    /// <summary>
    /// This model represents a transmission model for the 'Track' data unit.
    /// </summary>

    public partial class Track : SEMusicStoreBase.Common.Contracts.ITrack
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Track"/> class (created by the generator.)
        /// </summary>
        public Track()
        {
            Constructing();
        ...
        {
            bool result = false;
            if (obj is Models.Track other)
            {
                result = base.Equals(other) && AlbumId == other.AlbumId
        ...
        {
            return this.CalculateHashCode(base.GetHashCode(), AlbumId, GenreId, Title, Composer, Milliseconds, Bytes, UnitPrice);
        }
    }
}
