...
{
    using TEntity = Entities.Track;
    using TContract = SEMusicStoreBase.Common.Contracts.ITrack;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class TrackSet : EntitySet<TEntity>, Contracts.ITrackSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrackSet"/> class (created by the generator.)
        /// </summary>
        public TrackSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
