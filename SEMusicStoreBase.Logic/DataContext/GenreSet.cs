...
{
    using TEntity = Entities.Genre;
    using TContract = SEMusicStoreBase.Common.Contracts.IGenre;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class GenreSet : EntitySet<TEntity>, Contracts.IGenreSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenreSet"/> class (created by the generator.)
        /// </summary>
        public GenreSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
