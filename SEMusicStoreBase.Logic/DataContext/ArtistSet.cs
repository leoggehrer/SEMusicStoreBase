...
{
    using TEntity = Entities.Artist;
    using TContract = SEMusicStoreBase.Common.Contracts.IArtist;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class ArtistSet : EntitySet<TEntity>, Contracts.IArtistSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArtistSet"/> class (created by the generator.)
        /// </summary>
        public ArtistSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
