...
namespace SEMusicStoreBase.MVVMApp.ViewModels
{
    ...
    /// </summary>
    public partial class GenresViewModel : GenericItemsViewModel<Models.Genre>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static GenresViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenresViewModel"/> class (created by the generator.)
        /// </summary>
