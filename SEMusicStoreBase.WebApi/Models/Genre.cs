...
namespace SEMusicStoreBase.WebApi.Models
{
    using System;
    /// <summary>
    /// This model represents a transmission model for the 'Genre' data unit.
    /// </summary>

    public partial class Genre : SEMusicStoreBase.Common.Contracts.IGenre
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Genre"/> class (created by the generator.)
        /// </summary>
        public Genre()
        {
            Constructing();
