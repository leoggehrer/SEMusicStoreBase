...
{
    using TModel = SEMusicStoreBase.WebApi.Models.Track;
    using TEntity = SEMusicStoreBase.Logic.Entities.Track;
    using TContract = SEMusicStoreBase.Common.Contracts.ITrack;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    public sealed partial class TracksController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
