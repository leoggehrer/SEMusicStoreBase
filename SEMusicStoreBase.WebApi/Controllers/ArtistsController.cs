...
{
    using TModel = SEMusicStoreBase.WebApi.Models.Artist;
    using TEntity = SEMusicStoreBase.Logic.Entities.Artist;
    using TContract = SEMusicStoreBase.Common.Contracts.IArtist;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    public sealed partial class ArtistsController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
