...
{
    using TModel = SEMusicStoreBase.WebApi.Models.Genre;
    using TEntity = SEMusicStoreBase.Logic.Entities.Genre;
    using TContract = SEMusicStoreBase.Common.Contracts.IGenre;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    public sealed partial class GenresController(Contracts.IContextAccessor contextAccessor) : Controllers.GenericEntityController<TModel, TEntity, TContract>(contextAccessor)
    {
        /// <summary>
