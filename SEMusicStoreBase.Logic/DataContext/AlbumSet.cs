...
{
    using TEntity = Entities.Album;
    using TContract = SEMusicStoreBase.Common.Contracts.IAlbum;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class AlbumSet : EntitySet<TEntity>, Contracts.IAlbumSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlbumSet"/> class (created by the generator.)
        /// </summary>
        public AlbumSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
