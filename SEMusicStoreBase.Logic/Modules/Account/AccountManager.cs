//@CodeCopy
#if ACCOUNT_ON
using SEMusicStoreBase.Logic.Entities.Account;
using SEMusicStoreBase.Logic.Modules.Exceptions;
using SEMusicStoreBase.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEMusicStoreBase.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEMusicStoreBase.Common.Modules.ThreadSafe;
