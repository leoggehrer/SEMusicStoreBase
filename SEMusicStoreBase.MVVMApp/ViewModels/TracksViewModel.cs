...
namespace SEMusicStoreBase.MVVMApp.ViewModels
{
    ...
    /// </summary>
    public partial class TracksViewModel : GenericItemsViewModel<Models.Track>
    {
        /// <summary>
        /// Initializes the class (created by the generator).
        /// </summary>
        static TracksViewModel()
        {
            ClassConstructing();
            ClassConstructed();
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TracksViewModel"/> class (created by the generator.)
        /// </summary>
